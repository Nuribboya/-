...
class TelegramNotifier:
    ...
    async def _send_async(self, messages: list[tuple[str, str | None]], document: Path | None):
    ...
    def _run(self, messages, document=None) -> None:
        asyncio.run(self._send_async(messages, document))
    ...
    def send_alert(self, a: ChannelAnalysis, tz: ZoneInfo, report_path: Path | None = None,
        ...
        self._run(messages, report_path)
